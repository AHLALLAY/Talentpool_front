...
export default function Login() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center px-4">
            <form className="bg-gray-950 bg-opacity-90 border border-cyan-500 shadow-[0_0_20px_rgba(6,182,212,0.3)] backdrop-blur-md rounded-xl p-8 w-full max-w-md text-white">
                {/* Header */}
